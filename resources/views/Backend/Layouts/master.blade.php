...
<!-- Mirrored from demo.dashboardpack.com/user-management-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jan 2023 11:58:15 GMT -->
<head>
...
<nav class="sidebar">
    ...
    <ul id="sidebar_menu">
    <li class="mm-active">
        <a href="{{url('/home')}}" aria-expanded="false" class="active">
    ...
    <ul>
    <li><a href="index_2.html">Company Informations</a></li>
    <li><a href="{{route('main_menu.index')}}">Main Menu</a></li>
    <li><a href="{{route('sub_menu.index')}}">Sub Menu</a></li>
    </ul>
    </li>
    <li class="">
    <a class="has-arrow" href="#" aria-expanded="false">
    ...
    <a class="has-arrow" href="#" aria-expanded="false">
    <div class="nav_icon_small">
    <img src="{{asset('Backend')}}/img/menu-icon/17.svg" alt="">
    </div>
    <div class="nav_title">
    <span>Table</span>
    </div>
    ...
    <a class="has-arrow" href="#" aria-expanded="false">
    <div class="nav_icon_small">
    <img src="{{asset('Backend')}}/img/menu-icon/18.svg" alt="">
    </div>
    <div class="nav_title">
    <span>Cards</span>
    </div>
    ...
    <a class="has-arrow" href="#" aria-expanded="false">
    <div class="nav_icon_small">
    <img src="{{asset('Backend')}}/img/menu-icon/19.svg" alt="">
    </div>
    <div class="nav_title">
    <span>Charts</span>
    </div>
    ...
    <a class="has-arrow" href="#" aria-expanded="false">
    <div class="nav_icon_small">
    <img src="{{asset('Backend')}}/img/menu-icon/21.svg" alt="">
    </div>
    <div class="nav_title">
    <span>Widgets</span>
    </div>
...
<li>
<a class="CHATBOX_open" href="#"> <img src="{{asset('Backend')}}/img/icon/msg.svg" alt=""> <span>2</span> </a>
</li>
</div>
...
<!-- Mirrored from demo.dashboardpack.com/user-management-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jan 2023 11:59:05 GMT -->
</html>
