...
<div class="main_content_iner ">
    ...
    <div class="QA_section">
        <div class="QA_table mb_30">
            ...
            <form action="{{route('main_menu.store')}}" method="post" id="form">
                @csrf
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <label>Main Menu Name</label><span class="text-danger" style="font-size: 15px;">*</span>
                            <div class="mt-1">
                            <input type="text" class="form-control form-control-sm @error('main_menu_name') is-invalid @enderror" name="main_menu_name" id="inputText" placeholder="">
                            </div>
                    ...
                    <div class="col-4">
                        ...
                        <label>Icon Name</label><span class="text-danger" style="font-size: 15px;">*</span>
                            <div class="mt-1">
                            <input type="text" class="form-control form-control-sm @error('icon') is-invalid @enderror" name="icon" id="inputText" value="fas fa-stop-circle">
                            </div>
                            @error('icon')
                                <div class="alert alert-danger alert-sm">{{ $message }}</div>
                            @enderror
